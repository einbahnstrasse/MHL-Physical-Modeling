var store = [{
    ...
    "title": "About",
    "excerpt":"Tempor velit sint sunt ipsum tempor enim ad qui ullamco. Est dolore anim ad velit duis dolore minim sunt aliquip amet commodo labore. Ut eu pariatur aute ea aute excepteur laborum. Esse ea esse excepteur minim mollit qui cillum excepteur ex dolore magna. Labore deserunt fugiat incididunt incididunt sint ea....","url": "/about/"
  },{
    "title": "Posts by Category",
    "excerpt":" ","url": "/categories/"
  },{
    "title": "Final Exam: Mixed Piece with Max Patch",
    "excerpt":"Deadline: Week 13: 25 June 1. Overview The final exam is a composition for instrument(s) with electronics realized in MaxMSP with occasional checkpoints where I evaluate your progress throughout the semester. For example, our Midterm Exam is one such checkpoint. Your project may be conceived as a work-in-progress but must...","url": "/final-mixed-piece/"
  },{
    "title": "Grading",
    "excerpt":"   A list of assignments, deadlines, and points to help you plan for the semester.  For an overview of grading policies for this course, see XI. General Grading Rubric, located in the SYLLABUS.   Coming soon!       ","url": "/grading/"
  },{
    "title": "Syllabus",
    "excerpt":"1. Essential Contact Information Course Number: 00791 Semester: Summer 2024 Time: Tuesdays 14:30-16:00 Location: 2.43 Electronic Music Studio Format: Seminar Modality: In-person* Instructor: Louis Goldford Email: Louis.Goldford@mh-luebeck.de Office Hours: Monday — Wednedsay by appointment Office Location: 2.47A “The Aquarium” (next to 2.43 Electronic Music Studio) MHL Discord Server: https://discord.gg/ZQWrjtwq Course...","url": "/"
  },{
    "title": null,
    "excerpt":"/*! * Minimal Mistakes Jekyll Theme 4.24.0 by Michael Rose * Copyright 2013-2020 Michael Rose - mademistakes.com | @mmistakes * Licensed under MIT (https://github.com/mmistakes/minimal-mistakes/blob/master/LICENSE) */ /* Variables */ /* ========================================================================== Variables ========================================================================== */ /* Typography ========================================================================== */ @import url(\"https://fonts.googleapis.com/css2?family=Raleway:ital,wght@0,100;0,400;0,600;1,100;1,400;1,600&display=swap\"); @font-face { font-family: 'Florencesans-Exp-Bold'; src: url(\"https://einbahnstrasse.github.io/MHL-Physical-Modeling/assets/fonts/Florencesans-Exp-Bold.ttf.woff\") format(\"woff\"), url(\"https://einbahnstrasse.github.io/MHL-Physical-Modeling/assets/fonts/Florencesans-Exp-Bold.ttf.svg#Florencesans-Exp-Bold\") format(\"svg\"), url(\"https://einbahnstrasse.github.io/MHL-Physical-Modeling/assets/fonts/Florencesans-Exp-Bold.ttf.eot\"), url(\"https://einbahnstrasse.github.io/MHL-Physical-Modeling/assets/fonts/Florencesans-Exp-Bold.ttf.eot?#iefix\")...","url": "/assets/main.css"
  },{
    "title": "Software + Resources",
    "excerpt":"A list of stuff we’ll be using throughout the course. Be sure to install + verify these applications before their respective deadlines listed on our Schedule page. MaxMSP Download + install the current build from: MaxMSP Most recent releases should support our work in class, however. At the time of...","url": "/resources/"
  },{
    "title": "Schedule",
    "excerpt":"This page will be updated frequently with examples, video tutorials, links to new resources, and occasional updates to LAB ASSIGNMENTS. Our schedule follows the Current MHL Academic Calendar. The following topics and their precise order may change. Check here for updates! Week 1: 2 April Introduction to the BACH library...","url": "/schedule/"
  },{
    "title": "Story Curves Project",
    "excerpt":"Deadline: Week 7: 14 May 1. Watch the Video Enable German subtitles if it would help. Kurt Vonnegut (1922-2007) was an author of fiction with an engineering background, who thought mathematically about the form of his stories, which include notable works such as Slauterhouse-Five, Cat’s Cradle, Breakfast of Champions, A...","url": "/story-curves/"
  },{
    "title": "Posts by Tag",
    "excerpt":" ","url": "/tags/"
  },{
    "title": "XLR Cable Coiling",
    "excerpt":"Deadline: Week 6: 7 May Microphones and speakers are connected using 3-pin XLR cables: When it comes to wrapping cables (“coiling” or “rolling”), there are some good practice habits to form. Watch the video below for instructions on how to do this properly: By the deadline, email me a short...","url": "/xlr-cable-coiling/"
  },{
    "title": "Posts by Year",
    "excerpt":" ","url": "/posts/"
  },{
